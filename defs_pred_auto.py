...
def ticker_list(end_info_day):
    ...
    result_df = result_df[result_df['5일 평균 거래대금'] >= 400000000000]
...
def scrap_sub_data(end_info_day, day_120, day_21):
    ...
    KSI_df = fdr.DataReader('KS11', day_21, end_info_day).reset_index().drop(['Change','UpDown','Comp', 'Amount', 'MarCap'], axis=1).round(2)
